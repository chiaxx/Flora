document.addEventListener("DOMContentLoaded", () => {
  ...
  // Add event listeners to "Add to Cart" buttons in home__title section
  const homeAddToCartButtons = document.querySelectorAll(".home__button");
  homeAddToCartButtons.forEach((button) => {
      button.addEventListener("click", () => {
          const title = button.parentElement.parentElement.querySelector(".home__title").textContent;
          const price = button.parentElement.parentElement.querySelector(".home__price").textContent;
          handleAddCartItem(title, price, ""); // You may pass an empty string as imgSrc, as there's no image in the home section
      });
  });

  // Add event listeners to "Add to Cart" buttons in featured__title section
  const featuredAddToCartButtons = document.querySelectorAll(".featured__button");
  featuredAddToCartButtons.forEach((button) => {
      button.addEventListener("click", () => {
          const title = button.parentElement.querySelector(".featured__title").textContent;
          const price = button.parentElement.querySelector(".featured__price").textContent;
          handleAddCartItem(title, price, ""); // You may pass an empty string as imgSrc, as there's no image in the featured section
      });
  });
